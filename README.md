...
- [`llm-wiki/`](llm-wiki/) — LLM-Wiki guide, local copies, and raw source chooser.
- [`llm-wiki/HowTo-LLM-Wiki.md`](llm-wiki/HowTo-LLM-Wiki.md) — build a basic LLM Wiki with Claude Code.
- [`llm-wiki/raw-sources/`](llm-wiki/raw-sources/) — choose `memory/` for the agent-memory synthesis demo or `kids-books/` for a simpler ingestion demo.
