...
Provide a command-line interface that evaluates arithmetic expressions either in one-shot mode (from command-line arguments) or in an interactive REPL, formatting results sensibly and reporting errors without crashing.
