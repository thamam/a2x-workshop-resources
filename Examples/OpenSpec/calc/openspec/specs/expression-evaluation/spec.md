...
Evaluate arithmetic expressions over numeric operands, honoring standard operator precedence, associativity, parentheses, unary minus, and decimal numbers, while reporting invalid syntax and math errors as recoverable, structured errors.
